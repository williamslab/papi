...
def computeLoglikelihood_cnsPM(D, pars, phi=69.314):
...
#{{{ 
    ...
    loglik=0
    for d in D:
        loglik+=computeLoglikelihood_cnsPM_single(d,pars,phi,bg)

#}}}
    return(loglik)


def computeLoglikelihood_cnsPM_single(D, pars, phi,bg):
